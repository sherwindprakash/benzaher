      ...
      <div class="ProductSingleHolder">
        ...
        <div class="columns" style="padding-bottom: 100px">
          ...
          >
            ...
            <router-link
              style="color: black"
              class="MybtnNews"
              :to="'/products-&-services/products/spare_part/' + item._id"
            >
              <div
        ...
        >
          <div class="column col-12">
            <router-link to="/products-&-services/" class="Back" title="Back">
...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://binzaher.com/api/api/collections/get/spare_parts?token=b8766574e1a92b4e6296441248669c"
      )
      .then((response) => {
