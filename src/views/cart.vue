        ...
        <section v-else>
          ...
          <div v-else>
            ...
            <div v-if="this.info.length === 0" style="text-align: center">
              <h1>Cart is Empty</h1>
              <router-link class="btn btn-primary" to="/products-&-services/products"
                ...
                <div class="columns">
                  ...
                  >
                    ...
                    <div style="margin-top: 20px; margin-bottom: 20px">
                      ...
                      <!--  -->
                      <div
                        style="margin-top: 30px; margin-bottom: 30px; text-align: right"
                      >
                        <!-- CheckOUT -->
                        <form @submit.prevent="Pay">
                          <button
                            @click="key = 1"
                            :class="{ disabled: key == 1 }"
...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://binzaher.com/api/api/collections/get/cart?token=b8766574e1a92b4e6296441248669c"
      )
      .then((response) => {
