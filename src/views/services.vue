      ...
      <div class="who-we-areHolder" v-if="info">
        <div class="columns">
          <div class="column col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                  ...
                  <div class="modal-container" role="document">
                    <div class="modal-header">
                      <a
                        ...
                        aria-label="Close"
                      ></a>
                      <div class="modal-title h5">Single Services Booking</div>
                    </div>
            ...
            <div class="POPHolfer">
              <!--  -->
              <h5 style="color: #ababab">{{ info.minor_services_title }}</h5>

              <div class="column">
                <div v-if="Auth">
                  <a href="#minor_services">
                    <img
                      :src="
                        'https://binzaher.com/' + info.minor_services_image.path
                      "
                      class="PopUP"
                    />
                  </a>
                ...
                <div class="modal" id="minor_services">
                  <a
                    class="modal-overlay"
                    href="#modals"
                    aria-label="Close"
                  ...
                  <div class="modal-container" role="document">
                    <div class="modal-header">
                      <a
                        ...
                        aria-label="Close"
                      ></a>
                      <div class="modal-title h5">Minor Services Booking</div>
                    </div>
                    <div class="modal-body">
                      <div class="content">
                        <form
                          id="signup-form"
                          @submit.prevent="processForm_minor"
                        >
                          <div
                            class="columns"
                            style="display: flex; align-items: flex-end"
            ...
            ></iframe>
                              ...
                              <div class="form-group">
                                ...
                                >
                                  ...
                                  <option
                                    v-for="list in info.minor_services"
                                    :key="list"
                                  >
                                    {{ list.value.name }}
                                  </option>
            ...
            <div class="POPHolfer">
              <!--  -->
              <h5 style="color: #ababab">{{ info.major_services_title }}</h5>

              <div class="column">
                <div v-if="Auth">
                  <a href="#major_services">
                    <img
                      :src="
                        'https://binzaher.com/' + info.major_services_image.path
                      "
                      class="PopUP"
                    />
                  </a>
                ...
                <div class="modal" id="major_services">
                  <a
                    class="modal-overlay"
                    href="#modals"
                    aria-label="Close"
                  ...
                  <div class="modal-container" role="document">
                    <div class="modal-header">
                      <a
                        ...
                        aria-label="Close"
                      ></a>
                      <div class="modal-title h5">Major Services Booking</div>
                    </div>
                    <div class="modal-body">
                      <div class="content">
                        <form
                          id="signup-form"
                          @submit.prevent="processForm_major"
                        >
                          <div
                            class="columns"
                            style="display: flex; align-items: flex-end"
            ...
            ></iframe>
                              ...
                              <div class="form-group">
                                ...
                                >
                                  ...
                                  <option
                                    v-for="list in info.major_services"
                                    :key="list"
                                  >
                                    {{ list.value.name }}
                                  </option>
...
export default {
  ...
  methods: {
    ...
    processForm_minor: function () {
      //
      var data = JSON.stringify({
        data: {
          user: this.customersId,
          selected_service: this.selected_service,
          service_type: "Minor Services Booking",
          vehicle: this.vehicle,
          date: this.DateX,
          time: this.TimeX,
          note: this.Note,
    ...
    processForm_major: function () {
      //
      var data = JSON.stringify({
        data: {
          user: this.customersId,
          selected_service: this.selected_service,
          service_type: "Major Services Booking",
          vehicle: this.vehicle,
          date: this.DateX,
          time: this.TimeX,
          note: this.Note,
