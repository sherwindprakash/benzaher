    ...
    <div v-else>
      <div class="productsHolder" v-if="info">
        ...
        >
          ...
          >
            <router-link
              :to="`/products-&-services/products/kn/automotive/` + make"
...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://binzaher.com/api/api/collections/get/products?token=b8766574e1a92b4e6296441248669c&filter[brand]=kn&filter[sub_category]=automotive"
      )
      .then((response) => {
