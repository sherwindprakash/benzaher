        ...
        <Splide :options="options">
          <SplideSlide v-for="entries in info" :key="entries">
            <div class="CenterTitle">
              <h4 class="text-center">{{ entries.name_en }}</h4>
            ...
            <div style="text-align: center; padding-top: 20px">
              <router-link
                class="MybtnNews"
                :to="'/recommended/sponsorship/' + entries._id"
              >
                Read More
              </router-link>
            </div>
...
export default {
  ...
  mounted() {
    axios
      .get(
        "https://binzaher.com/api/api/collections/get/sponsorships?token=b8766574e1a92b4e6296441248669c"
      )
      .then((response) => {
